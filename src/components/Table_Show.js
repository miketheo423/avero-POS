...
import { createCheck, closeCheck, fetchChecks, fetchMenuItems, fetchOneCheck, addItem, voidItem } from '../actions';
...
export default connect(mapStateToProps, { createCheck, fetchMenuItems, fetchOneCheck, addItem, fetchChecks, voidItem, closeCheck })(TableShow);